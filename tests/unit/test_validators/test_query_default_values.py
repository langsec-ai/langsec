...
class TestBasicQueriesWithDefaultContext:
    def test_simple_select(self, security_guard_with_default_values):
        """Test basic SELECT query validation."""
        query = "SELECT id, username FROM users WHERE created_at > '2024-01-01'"
        assert security_guard_with_default_values.validate_query(query)

    def test_denied_column(self, security_guard_with_default_values):
        ...
        with pytest.raises(ColumnAccessError):
            security_guard_with_default_values.validate_query(query)

    def test_missing_where_clause(self, security_guard_with_default_values):
        """Test that missing WHERE clause is caught."""
        query = "SELECT id, username FROM users"
        with pytest.raises(QueryComplexityError):
            security_guard_with_default_values.validate_query(query)

    def test_invalid_table(self, security_guard_with_default_values):
...
class TestColumnAccessWithDefaultContext:
    def test_allowed_column(self, security_guard_with_default_values):
    ...
    def test_allowed_aggregation(self, security_guard_with_default_values):
        """Test that allowed aggregations are allowed."""
        query = "SELECT SUM(amount) as total_amount FROM orders"
        assert security_guard_with_default_values.validate_query(query)

    def test_denied_aggregation(self, security_guard_with_default_values):
        """Test that denied aggregations are caught."""
        query = "SELECT AVG(amount) as avg_amount FROM orders"
        with pytest.raises(QueryComplexityError):
            security_guard_with_default_values.validate_query(query)

    def test_allowed_where_column(self, security_guard_with_default_values):
        """Test that allowed WHERE columns are allowed."""
        query = "SELECT * FROM users WHERE created_at > '2024-01-01'"
        assert security_guard_with_default_values.validate_query(query)

    def test_denied_where_column(self, security_guard_with_default_values):
        """Test that denied WHERE columns are caught."""
        query = "SELECT * FROM users WHERE email = 'a@a.com'"
        with pytest.raises(ColumnAccessError):
            security_guard_with_default_values.validate_query(query)

    def test_column_not_in_schema(self, security_guard_with_default_values):
...
class TestJoinsWithDefaultContext:
    def test_valid_joins(self, security_guard_with_default_values):
        ...
        """
        security_guard_with_default_values.validate_query(query1)  # Should not raise
        ...
        query2 = """
            ...
            WHERE users.created_at > '2024-01-01'
        """
        security_guard_with_default_values.validate_query(query2)  # Should not raise
        ...
        query3 = """
            ...
            WHERE users.created_at > '2024-01-01'
        """
        security_guard_with_default_values.validate_query(query3)  # Should not raise

    def test_allowed_join(self, security_guard_with_default_values):
    ...
    # def test_invalid_join_type(self, security_guard_with_default_values):
    ...
    def test_too_many_joins(self, security_guard_with_default_values):
...
class TestAggregationsWithDefaultContext:
    ...
    def test_invalid_aggregation(self, security_guard_with_default_values):
...
class TestAliasesWithDefaultContext:
    def test_table_aliases(self, security_guard_with_default_values):
    ...
    def test_column_aliases(self, security_guard_with_default_values):
    ...
    def test_complex_aliases(self, security_guard_with_default_values):
    ...
    def test_aliased_aggregations(self, security_guard_with_default_values):
    ...
    def test_denied_column_with_alias(self, security_guard_with_default_values):
    ...
    def test_nonexistent_column_with_alias(self, security_guard_with_default_values):
